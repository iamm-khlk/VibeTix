  ...
  <body>
    <nav class="navbar navbar-expand-lg bg-white sticky-top shadow-sm py-1" id="mainNavbar">
      <div class="container">
        ...
        <a href="../public/index.html" class="navbar-brand fw-bold order-lg-1 mx-auto mx-lg-0 me-lg-4" style="font-size: 1.6rem"> <span style="color: #8a4fff">Vibe</span><span style="color: #ff6600">Tix</span> </a>
