...
<html lang="en">
  <head>
    ...
    <title>Payment Confirmation - VibeTix</title>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="payment-details">
                ...
                <div class="bank-details">
                  ...
                  <p><strong>Account Name:</strong> PT VibeTix Indonesia</p>
          ...
          Dana: {
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="payment-details">
                ...
                <div class="bank-details">
                  <p><strong>Dana Number:</strong> 0857-8332-3679</p>
                  <p><strong>Account Name:</strong> VibeTix Official</p>
                  <p><strong>Amount:</strong> <span class="payment-amount">Rp 1,500,000</span></p>
                </div>
          ...
          OVO: {
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="payment-details">
                ...
                <div class="bank-details">
                  <p><strong>OVO Number:</strong> 0857-8332-3679</p>
                  <p><strong>Account Name:</strong> VibeTix Official</p>
                  <p><strong>Amount:</strong> <span class="payment-amount">Rp 1,500,000</span></p>
                </div>
                <p class="text-muted small">Please include your order number (CTX-2025-XXXX) in the payment note.</p>
          ...
          GoPay: {
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="payment-details">
                ...
                <div class="bank-details">
                  <p><strong>GoPay Number:</strong> 0857-8332-3679</p>
                  <p><strong>Account Name:</strong> VibeTix Official</p>
                  <p><strong>Amount:</strong> <span class="payment-amount">Rp 1,500,000</span></p>
                </div>
                <p class="text-muted small">Please include your order number (CTX-2025-XXXX) in the payment note.</p>
          ...
          QRIS: {
            ...
            <div class="qris-payment-container">
              ...
              <div class="qr-code-container">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://vibetix.example.com/pay/CTX-2025-XXXX" 
          ...
          ShopeePay: {
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="payment-details">
                ...
                <div class="bank-details">
                  <p><strong>ShopeePay Number:</strong> 0857-8332-3679</p>
                  <p><strong>Account Name:</strong> VibeTix Official</p>
                  <p><strong>Amount:</strong> <span class="payment-amount">Rp 1,500,000</span></p>
                </div>
                <p class="text-muted small">Please include your order number (CTX-2025-XXXX) in the payment note.</p>
          ...
          LinkAja: {
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="payment-details">
                ...
                <div class="bank-details">
                  <p><strong>LinkAja Number:</strong> 0857-8332-3679</p>
                  <p><strong>Account Name:</strong> VibeTix Official</p>
                  <p><strong>Amount:</strong> <span class="payment-amount">Rp 1,500,000</span></p>
                </div>
                <p class="text-muted small">Please include your order number (CTX-2025-XXXX) in the payment note.</p>
